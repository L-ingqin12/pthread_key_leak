...
function(rapids_cpm_run_git_patch file issue)
  ...
  if(result EQUAL 0)
    list(APPEND msg_state "rapids-cmake [libcudacxx]: applied ${ext} ${file_name} to fix issue: '${issue}'")
  else()
    list(APPEND msg_state "rapids-cmake [libcudacxx]: failed to apply ${ext} ${file_name}")
    list(APPEND msg_state "rapids-cmake [libcudacxx]: git ${ext} output: ${repo_error_info}")
  endif()
...
set(files "/mnt/d/CLionProjects/pthread_key_leak/third_party/rapids-cmake/rapids-cmake/cpm/patches/libcudacxx/install_rules.diff;/mnt/d/CLionProjects/pthread_key_leak/third_party/rapids-cmake/rapids-cmake/cpm/patches/libcudacxx/reroot_support.diff;/mnt/d/CLionProjects/pthread_key_leak/third_party/rapids-cmake/rapids-cmake/cpm/patches/libcudacxx/proclaim_return_type_nv_exec_check_disable.diff;/mnt/d/CLionProjects/pthread_key_leak/third_party/rapids-cmake/rapids-cmake/cpm/patches/libcudacxx/memory_resource.diff")
set(issues "libcudacxx installs incorrect files [https://github.com/NVIDIA/libcudacxx/pull/428];Support conda-forge usage of CMake rerooting [https://github.com/NVIDIA/libcudacxx/pull/490], requires libcudacxx/install_rules.diff.;Use pragma to disable execution checks in cuda::proclaim_return_type. [https://github.com/NVIDIA/libcudacxx/pull/448];Allow {async_}resource_ref to be constructible from a pointer. [https://github.com/NVIDIA/libcudacxx/pull/439]")
set(output_file "/mnt/d/CLionProjects/pthread_key_leak/build_ohos/rapids-cmake/patches/libcudacxx/log")
